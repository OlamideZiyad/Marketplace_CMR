...
module.exports = (sequelize) => {
  const ProductImage = sequelize.define('ProductImage', {
    ...
    productId: {
      ...
      validate: {
        notEmpty: {
          msg: 'L\'ID du produit est requis'
        },
        isUUID: {
          args: 4,
          msg: 'L\'ID du produit doit être un UUID valide'
        }
      }
    },
    url: {
    ...
    publicId: {
      ...
      validate: {
        notEmpty: {
          msg: 'Le public ID Cloudinary est requis'
        }
      }
    },
    isPrimary: {
  ...
  validate: {
    ...
    width: {
      ...
      validate: {
        min: {
          args: 1,
          msg: 'La largeur doit être positive'
        }
      }
    },
    height: {
      ...
      validate: {
        min: {
          args: 1,
          msg: 'La hauteur doit être positive'
        }
      }
    },
    format: {
    ...
    size: {
      ...
      validate: {
        min: {
          args: 1,
          msg: 'La taille doit être positive'
        }
      }
    }
  }, {
    ...
    hooks: {
      // Hook avant création : si isPrimary=true, désactiver les autres images primaires
